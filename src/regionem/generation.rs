...
pub fn generate_terrain_data() -> Terrain{
    ...
    for x in 0..TERRAIN_SIZE {
        ...
        for z in 0..TERRAIN_SIZE {
            data[x as usize].push(((fbm.get([
                (((x as f32) / TERRAIN_SIZE as f32)*TERRAIN_WORLDSCALE*TERRAIN_NOISESCALE) as f64,
                (((z as f32) / TERRAIN_SIZE as f32)*TERRAIN_WORLDSCALE*TERRAIN_NOISESCALE) as f64,
                0f64]
            ) as f64)*TERRAIN_HEIGHT as f64) as f32);
        }
    }
